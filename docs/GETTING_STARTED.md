...
Example: `mongodb+srv://botuser:MyPassword123@cluster0.abc123.mongodb.net/polymarket`
...
After running `npm run setup`, you'll have a `.env` file. Here are the key settings:
